...
var dialog = [
	...
	"What are you up to?",
	"I have classified government secrets and the CIA is after me.",
	...
	"Is that cat glowing?",
	"Is feels like a cold brew with oat milk typa day?",
	"why are these cats so purrfect?",
	...
	"This would be a great place for a rave!",
	"So, are we just going to ignore PITA?",
	"So, how much is it for a pistachio cappuccino?",
	"Do you guys make skim goat milk double espresso shot chai lattes?",
	"Squango? What an odd name",
	"What's the meaning of life?",
	"So, what's on the menu?",
	"Did you see the protestors outside?",
	...
	"Sometimes I sleep with my head at the foot of my bed just to prove that i can.",
	"So, what do we want? A coffee worth fighting for!",
	"How much for a giant macaroon?",
